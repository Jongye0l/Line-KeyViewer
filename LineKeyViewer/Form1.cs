    ...
    public partial class App : Form {
        ...
        private async void HookKeyDown(object sender, KeyEventArgs e) {
            try {
                ...
                else if(key2 == keyCode) Press2();
                else if(key3 == keyCode) Press3();
                else if(key4 == keyCode) Press4();
                else if(key5 == keyCode) Press5();
                else if(key6 == keyCode) Press6();
                else if(key7 == keyCode) Press7();
                else if(key8 == keyCode) Press8();
                else if(key9 == keyCode) Press9();
                else if(key10 == keyCode) Press10();
                else if(key11 == keyCode) Press11();
                else if(key12 == keyCode) Press12();
                else if(key13 == keyCode) Press13();
                else if(key14 == keyCode) Press14();
                else if(key15 == keyCode) Press15();
                else if(key16 == keyCode) Press16();
                CheckHeadClick();
            } catch (Exception) {
                // ignored
            }
        ...
        private async void HookKeyUp(object sender, KeyEventArgs e) {
            try {
                ...
                else if(key2 == keyCode && right_pressed.Contains(keyCode)) UnPress2();
                else if(key3 == keyCode && right_pressed.Contains(keyCode)) UnPress3();
                else if(key4 == keyCode && right_pressed.Contains(keyCode)) UnPress4();
                else if(key5 == keyCode && left_pressed.Contains(keyCode)) UnPress5();
                else if(key6 == keyCode && left_pressed.Contains(keyCode)) UnPress6();
                else if(key7 == keyCode && left_pressed.Contains(keyCode)) UnPress7();
                else if(key8 == keyCode && left_pressed.Contains(keyCode)) UnPress8();
                else if(key9 == keyCode && right_pressed.Contains(keyCode)) UnPress9();
                else if(key10 == keyCode && right_pressed.Contains(keyCode)) UnPress10();
                else if(key11 == keyCode && right_pressed.Contains(keyCode)) UnPress11();
                else if(key12 == keyCode && right_pressed.Contains(keyCode)) UnPress12();
                else if(key13 == keyCode && left_pressed.Contains(keyCode)) UnPress13();
                else if(key14 == keyCode && left_pressed.Contains(keyCode)) UnPress14();
                else if(key15 == keyCode && left_pressed.Contains(keyCode)) UnPress15();
                else if(key16 == keyCode && left_pressed.Contains(keyCode)) UnPress16();
                CheckHeadClick();
            } catch (Exception) {
                // ignored
            }
